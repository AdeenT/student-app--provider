...
import 'package:stutents_lists/db_function/db_function.dart';
...
class _EditScreenState extends State<EditScreen> {
  ...
  String imageToString = 'assets/image/person.jpg';
  ...
  void save(ctx) async {
    ...
    updateStudent(ctx,widget.data, studentModel);
    if (!mounted) {
      return;
    }
